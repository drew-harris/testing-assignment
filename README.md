...
![alt text] (https://github.com/drew-harris/testing-assignment/blob/main/src/images/TestCasesTerminal3.PNG)
...
# 2. questionTwo.ts and 2. questionTwo.test.ts corresponds to this question:
...
# 3. questionThree.ts and 3. questionThree.test.ts corresponds to this question:
...
# 4. questionFour.ts and 4. questionFour.test.ts corresponds to this question:
...
# 5. questionFive.ts and 5. questionFive.test.ts corresponds to this question:
...
# 6. questionSix.ts and 6. questionSix.test.ts corresponds to this question:
...
# 7. questionSeven.ts and 7. questionSeven.test.ts corresponds to this question:
...
# 8. questionEight.ts and 8. questionEight.test.ts corresponds to this question:
...
# 9. questionNine.ts and 9. questionNine.test.ts corresponds to this question:
...
# 10. questionTen.ts and 10. questionTen.test.ts corresponds to this question:
...
# 11. questionEleven.ts and 11. questionEleven.test.ts corresponds to this question:
...
# 12. questionTwelve.ts and 12. questionTwelve.test.ts corresponds to this question:
